...
Algumas configurações do PrismaPDF podem ser alteradas manualmente através do seu arquivo de configurações no formato INI. Mas é necessário atenção. Deixar o arquivo de configurações inválido, tornará o PDFPrisma inutilizável. Caso isto aconteça, reinstale o PDFPrisma.
