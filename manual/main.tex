...
1. Abra o Prisma e autentique-se com sua matrícula e senha.

\pagebreak
2. No menu principal, vá para BENEFÍCIOS.\\
\includegraphics[width=1.0\textwidth, center]{menu}\\

\vspace{0.3cm}
3. Na tela Benefícios, pressione a tecla *.\\
\includegraphics[width=1.0\textwidth, center]{beneficios}\\

\pagebreak
4. Na tela Cadastro da Impressora Padrão, pressione a tecla M seguida de ENTER.\\
\includegraphics[width=1.0\textwidth, center]{modimpressora}\\

\vspace{0.3cm}
5. Em seguida, pressione a tecla ? seguida de ENTER.

6. Na lista de impressoras, escolha Documento PDF e pressione ENTER duas vezes.\\
...
\begin{enumerate}
  ...
  \item Na lista de impressoras, escolha Laserjet e pressione ENTER duas vezes.
\end{enumerate}
