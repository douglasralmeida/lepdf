...
\title{Instruções de Uso do Componente PDF para Prisma 2.0}
...
\begin{itemize}
  \item O Componente PDF para Prisma é incompatível com Java 6. Se você precisa manter o Java 6 instalado no seu computador, você não poderá instalar este Componente PDF.
\end{itemize}
